...
def front(cube, is_clockwise=True):
    if (is_clockwise):
        return clockwise(
                cube.copy(), 
                cube['f'].copy(), 
...
def right(cube, is_clockwise=True):
    turned = {
        'f': cube['r'].copy(),
        'l': cube['f'].copy(),
        'r': cube['b'].copy(),
...
def left(cube, is_clockwise=True):
    turned = {
        'f': cube['l'].copy(),
        'l': cube['b'].copy(),
        'r': cube['f'].copy(),
...
def back(cube, is_clockwise=True):
    turned = {
        'f': cube['b'].copy(),
        'l': cube['r'].copy(),
        'r': cube['l'].copy(),
...
def top(cube, is_clockwise=True):
    turned = {
        'f': cube['t'].copy(),
...
def down(cube, is_clockwise=True):
    turned = {
        'f': cube['d'].copy(),
        'l': np.rot90(cube['l'].copy(), 1),
        'r': np.rot90(cube['r'].copy(), -1),
